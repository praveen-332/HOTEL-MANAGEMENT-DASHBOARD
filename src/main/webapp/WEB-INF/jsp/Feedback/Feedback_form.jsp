...
<div>
 ...
 <form:form modelAttribute="FeedbackForm" method="post" action="${saveURL }" >
  <form:hidden path="fid"/>  <table>

   <tr>
    <td> customerid: </td>
    <td>
     <form:input path="givenby"/>
    </td>
   </tr>
   
   <tr>
    <td style="height:200px">Feedback remarks: </td>
    <td>
     <form:input path="remarks"  placeholder="your feedback is valuable..."/>
    </td>
   </tr>
